$githubUser = "P6g9YHK6" # Change this here if you forked the repository.
$name= "P6g9YHK6" # Change this to your name.
$githubRepo = "unix-pwsh" # Change this here if you forked the repository and changed the name.
$global:githubBaseURL= "https://raw.githubusercontent.com/$githubUser/$githubRepo/main"
